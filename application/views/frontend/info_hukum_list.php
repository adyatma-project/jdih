                    ...
                    <form action="<?php echo site_url('Frontendinfohukum/info_hukum_list'); ?>" method="get">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <input type="text" class="form-control" name="nomor" placeholder="Nomor" value="<?php echo $nomor ?>">
                            </div>
                            <div class="col-md-3 mb-3">
                            ...
                            <div class="col-md-2 mb-3">
                                <select class="form-select" name="id_kategori_info">
                                    ...
                                    <?php foreach($ref_kategori as $value) { ?>
                                        <option value="<?php echo $value->id_kategori ?>" <?php echo ($id_kategori_info == $value->id_kategori) ? 'selected' : '' ?>><?php echo $value->kategori ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col-md-2 mb-3">
                        ...
                        <tbody>
                            <?php foreach ($ta_info_hukum_data as $ta_info_hukum) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()."frontendinfohukum/info_hukum_page/".$ta_info_hukum->id_info_hukum; ?>">
                                            <?php echo $ta_info_hukum->kategori; ?> Nomor <?php echo $ta_info_hukum->no; ?> Tahun <?php echo $ta_info_hukum->tahun ?>
                                        </a>
                                    </td>
