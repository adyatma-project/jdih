<style>
    ...
    .meta-value { color: #0f172a; font-weight: 600; width: 60%; text-align: right; word-break: break-word;}
...
$is_putusan   = (stripos($nm_kategori, 'putusan') !== false || stripos($nm_kategori, 'pengadilan') !== false);
                ...
                <div class="meta-list">
                    ...
                    <?php if($is_putusan): ?>
                         <?php if(!empty($jenis_peraturan)): ?>
                            <div class="meta-row"><span class="meta-label">Tipe Dokumen</span><span class="meta-value"><?= $jenis_peraturan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($tentang)): ?>
                            <div class="meta-row"><span class="meta-label">Judul</span><span class="meta-value"><?= $tentang ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($teu_badan)): ?>
                            <div class="meta-row"><span class="meta-label">T.E.U. Badan</span><span class="meta-value"><?= $teu_badan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($no_peraturan)): ?>
                            <div class="meta-row"><span class="meta-label">Nomor Putusan</span><span class="meta-value"><?= $no_peraturan ?></span></div>
                        <?php endif; ?>
                        ...
                        <?php if(!empty($singkatan_peradilan)): ?>
                            <div class="meta-row"><span class="meta-label">Singkatan Jenis Peradilan</span><span class="meta-value"><?= $singkatan_peradilan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($tempat_peradilan)): ?>
                            <div class="meta-row"><span class="meta-label">Tempat Peradilan</span><span class="meta-value"><?= $tempat_peradilan ?></span></div>
                        <?php endif; ?>
                        <div class="meta-row"><span class="meta-label">Tanggal-Bulan-Tahun dibacakan</span><span class="meta-value"><?= format_tgl($tgl_putusan) ?></span></div>
                       <?php if(!empty($sumber)): ?>
                            <div class="meta-row"><span class="meta-label">Sumber</span><span class="meta-value"><?= $sumber ?></span></div>
                        <?php endif; ?>
                        <?php if(isset($status_putusan)): ?>
                            <div class="meta-row"><span class="meta-label">Status Putusan</span><span class="meta-value"><?= $status_putusan ?></span></div>
                        <?php endif; ?>S
                         <?php if(isset($bahasa)): ?>
                            <div class="meta-row"><span class="meta-label">Bahasa</span><span class="meta-value"><?= $bahasa ?></span></div>
                        <?php endif; ?>
                        <?php if(isset($bidang_hukum)): ?>
                            <div class="meta-row"><span class="meta-label">Bidang Hukum / Jenis Perkara</span><span class="meta-value"><?= $bidang_hukum ?></span></div>
                        <?php endif; ?> 

                    <?php if(isset($lokasi)): ?>
                            <div class="meta-row"><span class="meta-label">Lokasi</span><span class="meta-value"><?= $lokasi ?></span></div>
                        <?php endif; ?> 
                    ...
                    <?php elseif($is_monografi): ?>
                         <?php if(!empty($tipe_dokumen)): ?>
                            <div class="meta-row"><span class="meta-label">Tipe Dokumen</span><span class="meta-value"><?= $tipe_dokumen ?></span></div>
                        <?php endif; ?>
                         <?php if(!empty($tentang)): ?>
                            <div class="meta-row"><span class="meta-label">Judul</span><span class="meta-value"><?= $tentang ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($teu_badan)): ?>
                            <div class="meta-row"><span class="meta-label">T.E.U. Orang/Badan</span><span class="meta-value"><?= $teu_badan ?></span></div>
                        <?php endif; ?>
                        
                        <?php if(!empty($nomor_panggil)): ?>
                            <div class="meta-row"><span class="meta-label">Nomor Panggil</span><span class="meta-value"><?= $nomor_panggil ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($cetakan_edisi)): ?>
                            <div class="meta-row"><span class="meta-label">Cetakan/Edisi</span><span class="meta-value"><?= $cetakan_edisi ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($tempat_terbit)): ?>
                            <div class="meta-row"><span class="meta-label">Tempat Terbit</span><span class="meta-value"><?= $tempat_terbit ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($penerbit)): ?>
                            <div class="meta-row"><span class="meta-label">Penerbit</span><span class="meta-value"><?= $penerbit ?></span></div>
                        <?php endif; ?>
                        <div class="meta-row"><span class="meta-label">Tahun Terbit</span><span class="meta-value"><?= $tahun ?></span></div>
                        ...
                        <?php endif; ?>
                        <?php if(!empty($isbn)): ?>
                            <div class="meta-row"><span class="meta-label">ISBN/ISSN</span><span class="meta-value"><?= $isbn ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($bahasa)): // Backup jika teu_badan kosong ?>
                            <div class="meta-row"><span class="meta-label">Bahasa</span><span class="meta-value"><?= $bahasa ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($bidang_hukum)): // Backup jika teu_badan kosong ?>
                            <div class="meta-row"><span class="meta-label">Bidang Hukum</span><span class="meta-value"><?= $bidang_hukum ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($nomor_induk_buku)): ?>
                            <div class="meta-row"><span class="meta-label">No. Induk Buku</span><span class="meta-value"><?= $nomor_induk_buku ?></span></div>
                        <?php endif; ?>
                    ...
                    <?php elseif($is_artikel): ?>
                       ...
                       <!-- cek kembali kesesuaiannya -->
                        <?php if(!empty($sumber) || !empty($nama_jurnal)): ?>
                            <div class="meta-row"><span class="meta-label">Sumber</span><span class="meta-value"><?= !empty($nama_jurnal) ? $nama_jurnal : $sumber ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($subjek)): ?>
                            <div class="meta-row"><span class="meta-label">Subjek</span><span class="meta-value"><?= $subjek ?></span></div>
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php endif; ?>
                        <?php if(!empty($teu_badan)): ?>
                            <div class="meta-row"><span class="meta-label">T.E.U. Badan/ Pengarang</span><span class="meta-value"><?= $teu_badan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($no_peraturan)): ?>
                            <div class="meta-row"><span class="meta-label">Nomor Peraturan</span><span class="meta-value"><?= $no_peraturan ?></span></div>
                        <?php endif; ?>
                         <?php if(!empty($jenis_peraturan)): ?>
                            <div class="meta-row"><span class="meta-label">Jenis / Bentuk Peraturan</span><span class="meta-value"><?= $jenis_peraturan ?></span></div>
                        <?php endif; ?>
                          <?php if(!empty($singkatan_jenis)): ?>
                            <div class="meta-row"><span class="meta-label">Singkatan Jenis / Bentuk Peraturan</span><span class="meta-value"><?= $singkatan_jenis ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($tempat_penetapan)): ?>
                            <div class="meta-row"><span class="meta-label">Tempat Penetapan</span><span class="meta-value"><?= $tempat_penetapan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($tgl_penetapan)): ?>
                            <div class="meta-row"><span class="meta-label">Tanggal-Bulan-Tahun Penetapan/Pengundangan</span><span class="meta-value"><?= $tgl_penetapan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($sumber)): ?>
                            <div class="meta-row"><span class="meta-label">Sumber</span><span class="meta-value"><?= $sumber ?></span></div>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if(!empty($status_peraturan)): ?>
                            <div class="meta-row"><span class="meta-label">Status Peraturan</span><span class="meta-value"><?= $status_peraturan ?></span></div>
                        <?php endif; ?>
                        <?php if(!empty($bahasa)): ?>
                            <div class="meta-row"><span class="meta-label">Bahasa</span><span class="meta-value"><?= $bahasa ?></span></div>
                        <?php endif; ?>
