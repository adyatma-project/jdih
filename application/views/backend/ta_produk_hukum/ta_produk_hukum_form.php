...
<section class="content">
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group bg-gray p-3" style="padding: 15px; border-radius: 5px; border-left: 5px solid #3c8dbc; margin-bottom: 20px;">
            ...
            <div id="form_container" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="tentang" rows="3" required placeholder="Tuliskan judul lengkap dokumen..."><?php echo $tentang; ?></textarea>
                </div>
                ...
                <div id="meta_peraturan" class="meta-group" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="teu_badan" value="<?php echo $teu_badan; ?>" placeholder="Contoh: Indonesia. Presiden / Bupati Donggala">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_peraturan" value="<?php echo $no_peraturan; ?>">
                            </div>
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jenis_peraturan" value="<?php echo $jenis_peraturan; ?>" placeholder="Contoh: Peraturan Daerah, Peraturan Bupati, Keputusan Kepala Dinas">
                    </div>

                    <div class="form-group">
                        <label>Singkatan Jenis / Bentuk Peraturan</label>
                        <input type="text" class="form-control" name="singkatan_jenis" value="<?php echo $singkatan_jenis; ?>" placeholder="Contoh: PERDA / PERBUP">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Sumber</label>
                        <input type="text" class="form-control" name="sumber" value="<?php echo $sumber; ?>" placeholder="Contoh: LD Kabupaten Donggala Tahun 2024 Nomor 1">
                    </div>

                    <div class="form-group" style="background-color: #f9f9f9; padding: 10px; border: 1px dashed #ccc;">
                        <label>Status Peraturan</label>
                        <input type="text" class="form-control" name="status_peraturan" value="<?php echo $status_peraturan; ?>" placeholder="Ketik status disini. Contoh: Berlaku, Dicabut, atau Mengubah...">
                ...
                <div id="meta_monografi" class="meta-group" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="penulis" value="<?php echo $penulis; ?>" placeholder="Nama Pengarang">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cetakan_edisi" value="<?php echo $cetakan_edisi; ?>">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="deskripsi_fisik" value="<?php echo $deskripsi_fisik; ?>" placeholder="Contoh: 400 hlm; 23cm">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nomor_induk_buku" value="<?php echo $nomor_induk_buku; ?>">
                    </div>
                </div>
                ...
                <div id="meta_artikel" class="meta-group" style="display:none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Tahun Terbit</label>
                                <input type="number" class="form-control" name="tahun_terbit_art" value="<?php echo $tahun; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Sumber</label>
                        <input type="text" class="form-control" name="nama_jurnal" value="<?php echo $sumber; ?>" placeholder="Contoh: Jurnal Hukum Nasional">
                    </div>
                    <!-- <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="jenis_peradilan" class="form-control">
                                    ...
                                    <option value="Peradilan Militer" <?php echo ($jenis_peradilan=='Peradilan Militer')?'selected':''; ?>>Peradilan Militer</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="singkatan_peradilan" value="<?php echo $singkatan_peradilan; ?>" placeholder="Contoh: PN / PA / MA">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Tempat Peradilan</label>
                        <input type="text" class="form-control" name="tempat_peradilan" value="<?php echo $tempat_peradilan; ?>" placeholder="Contoh: Donggala">
                    </div>
                    <div class="form-group">
                        <label>Tanggal-Bulan-Tahun Dibacakan</label>
                        <input type="date" class="form-control" name="tanggal_dibacakan" value="<?php echo $tanggal_dibacakan; ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="status_putusan" class="form-control">
                            ...
                            <option value="Tidak Tetap" <?php echo $status_putusan=='Tidak Tetap'?'selected':''; ?>>Belum Berkekuatan Hukum Tetap</option>
                        </select>
                    </div>
                    <!-- <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="subjek" value="<?php echo $subjek; ?>" required placeholder="Contoh: HUKUM PIDANA; RETRIBUSI">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Lokasi</label>
                            <input type="text" class="form-control" name="lokasi" value="<?php echo $lokasi; ?>" placeholder="Contoh: Lemari A Rak 2">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group well">
                    ...
                    <?php if($file){ ?>
                        <p class="help-block text-success"><i class="fa fa-check"></i> File saat ini: <a href="<?php echo base_url('uploads/produk_hukum/'.$file) ?>" target="_blank"><?php echo $file; ?></a></p>
                    <?php } ?>
                    <p class="help-block text-muted">Pastikan file yang diunggah dapat dibaca dengan jelas dan dalam bentuk File Dokumen (PDF).</p>
                </div>
                ...
                <div class="box-footer text-center" style="background: transparent; border-top: 1px solid #f4f4f4;">
                    <a href="<?php echo site_url('ta_produk_hukum') ?>" class="btn btn-default btn-lg"><i class="fa fa-arrow-left"></i> Kembali</a>
...
<script>
    $(document).ready(function() {
        ...
        function checkKategori() {
            ...
            if (selectedText.includes("pengadilan") || selectedText.includes("mahkamah") || selectedText.includes("yurisprudensi")) {
                $("#meta_putusan").show();
            } 
