...
<head>
  ...
  <style>
    ...
    .main-header .navbar {
        background: linear-gradient(to right, #1e3c72, #2a5298) !important; /* Biru Dongker Elegan */
        border: none;
    }
    .main-header .logo {
    ...
    .skin-blue .sidebar-menu>li>a {
        color: #555;
        font-weight: 500;
        border-radius: 0 25px 25px 0; /* Rounded tab effect */
        margin-right: 10px;
        transition: all 0.3s;
    }
    ...
    .box {
        border-radius: 10px;
        border-top: none; /* Hilangkan garis biru default adminlte */
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="<?php echo base_url('ubah_password') ?>" class="btn btn-default btn-flat">Ubah Password</a>
                  </div>
      ...
      <section class="sidebar">
        <div class="user-panel" style="background:transparent; margin-bottom: 20px;">
          <div class="pull-left image">
            <img src="<?php echo base_url(); ?>assets/AdminLTE-2.4.3/dist/img/logo.png" class="img-circle" alt="User Image" style="border: 2px solid #ddd;">
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="<?php echo base_url() ?>backend"><i class="fa fa-dashboard text-blue"></i> <span>Dashboard</span></a></li>
